...
M569 P3 S0                                 ; Drive 3 goes forwards (E0) was 1
M569 P4 S1                                 ; Drive 4 goes forwards (E1) 

M574 X2 Y2 Z2 S1                           ; set end stop configuration (all end stops at high end, active high)

M665 R150 L340.5 B145 H530 X0 Y0 Z0      ; delta radius, diagonal rod length, printable radius and homed height
...
M92 E830.0:830.0                           ; Set extruder steps/mm was 182

M906 X1500 Y1500 Z1500 E1400:1400 I50      ; Set motor currents (mA) and idle current %
;M201 X4200 Y4200 Z4200 E5000               ; Accelerations (mm/s^2)
M201 X2100 Y2100 Z2100 E5000               ; Accelerations (mm/s^2) -dkeogh
...
M566 X1200 Y1200 Z2000 E2000               ; Maximum instant speed changes mm/minute -dkeogh


M106 P1 S0                                 ; Set the cooling fan to zero
M106 P1 H-1                                ; Part Cooling Fan
M106 P2 T50 S255 H1                        ; Heat sink fan
...
M563 P0 D0 H1 F1                           ; Hot end (T0), drive (E0), heater (H1), Fan 1 (F1)
G10 P0 S0 R0                               ; Hot end operating and standby temperatures

;Dual Extrusion Code
M563 P1 D1 H1 F1                           ; Hot end (T1), drive (E1), heater (H1), Fan 1 (F1)
